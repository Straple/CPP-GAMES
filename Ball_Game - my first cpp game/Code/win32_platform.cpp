...
global_variable float time_fps_update_cooldown = 0.5f, time_between_fps = 0;
...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd) {
	...
	// Create window  // Создаем окно, но если мы не запустим бесконечный цикл, то оно тут же закроется
...
//
		...
		simulate_game(&input, delta_time, time);
		...
		LARGE_INTEGER frame_end_time; // Обновление скорости
